pipeline {
    ...
    stages {
      stage('CheckOut GitHub Repo') {
          steps {
              checkout([$class: 'GitSCM', branches: [[name: 'master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'githubaccess', url: 'git@github.com:si-vas/git-packer-ansible-terraform-jenkins-Integration.git']]])
            }
        }
